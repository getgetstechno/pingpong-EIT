...
/* read the uart to a string and only return the string if a line feed character
 * is received, otherwise return a empty string but keep the string in memory 
...
//string naar kommagetal omvormen
...
void uartHandler(void) {
    char * str = readLine();
    switch (*str) { //*str gives the value of the first char in the string
        case 0:
            break;
        case 'S': //Setpoint                            
        case 's':
